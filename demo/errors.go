...
/* By convention, errors are the last return value and have type "error", that is a built-in interface. */
...
// define method for custom error
func (e *argError) Error() string {
	return fmt.Sprintf("%d - %s", e.arg, e.prob)
}

/* In this function we use &argError{} syntax to build a new struct, supplying values for the two fields "arg" and prob.*/
